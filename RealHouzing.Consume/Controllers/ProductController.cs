...
namespace RealHouzing.Consume.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44370/api/Product");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:44370/api/Product/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> AddProduct(AddProductViewModel addProductViewModel)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:44370/api/Product", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> UpdateProduct(int id)
        {
            ...
            var responseMessage2 = await client2.GetAsync($"https://localhost:44370/api/Product/{id}");
